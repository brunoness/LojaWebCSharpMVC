...
namespace LojaWebCSharp.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        public DepartamentosController(LojaWebCSharpContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Departamento != null ? 
                          ...
                          Problem("Entity set 'LojaWebCSharpContext.Departamento'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LojaWebCSharpContext.Departamento'  is null.");
            }
            var departamento = await _context.Departamento.FindAsync(id);
            if (departamento != null)
            {
